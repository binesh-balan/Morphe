...
This document provides instructions on how to add additional language packs for the OCR tab in Morphe PDF, both inside and outside of Docker.
...
Morphe PDF uses Tesseract for its text recognition. All credit goes to them for this awesome work!
...
Depending on your requirements, you can choose the appropriate language pack for your use case. By default, Morphe PDF uses `tessdata_fast` for English, but this can be replaced.
