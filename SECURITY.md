...
The Morphe PDF team takes security vulnerabilities seriously. We appreciate your efforts to responsibly disclose your findings.
...
At this time, we do not offer a bug bounty program. However, we greatly appreciate your efforts in making Morphe PDF more secure and will acknowledge your contribution in our release notes (unless you prefer to remain anonymous).

## Supported Versions

Only the latest version of Morphe PDF is supported for security updates. We do not backport security fixes to older versions.
...
**Please note:** Before reporting a security issue, ensure you are using the latest version of Morphe PDF. Security reports for older versions will not be accepted.

## Security Best Practices

When deploying Morphe PDF:
