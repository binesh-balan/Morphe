...
const SITE_NAME = "Morphe PDF";
const SITE_TITLE = "Morphe PDF";
...
const SAAS_ROUTE_OVERRIDES = {
  "/processor": {
    ...
    title: "Morphe Processor - Govern every PDF your organization touches",
  ...
  "/editor": {
    ...
    title: "Morphe - The world's most secure PDF editor",
