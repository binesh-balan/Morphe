...
/**
 * Hero art for the inset panel. `appIcon` renders the Morphe app mark
...
export function ShellHero({
  ...
  if (appIcon) {
    return (
      <img src={stirlingMark} alt="Morphe" className={styles.heroAppIcon} />
    );
  }
          ...
          <div className={styles.card}>
            <header className={styles.header}>
              <div className={styles.brand}>
                ...
                />
                <span className={styles.wordmark}>Morphe</span>
              </div>
