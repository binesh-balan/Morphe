            ...
            if glyph_name in charstrings:
                try:
                    ...
                    try:
                        ...
                        pass  # Some glyphs may not have outlines - expected, not an error

                except Exception:  # noqa: BLE001, S110
                    pass  # Use defaults - expected, not an error
            ...
            if glyph_name.startswith("uni") and len(glyph_name) == 7:
                try:
                    ...
                    if unicode_val not in unicode_to_glyph:
                        unicode_to_glyph[unicode_val] = glyph_name
                except Exception:  # noqa: BLE001, S110 - non-hex glyph name, not this glyph's encoding
                    pass
